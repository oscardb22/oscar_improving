...
password_serializer = "apps.authentication.api.serializers."
...
login_serializer = "apps.authentication.api.serializers.login."
...
REST_FRAMEWORK = {
    ...
    # Pagination
    "DEFAULT_PAGINATION_CLASS": "oscar_improving.pagination.StandardResultsSetPagination",
    "PAGE_SIZE": 10,
    # Filtering
    "SEARCH_PARAM": "search",
    ...
    "EXCEPTION_HANDLER": "oscar_improving.general_error_handler.custom_exception_handler",
